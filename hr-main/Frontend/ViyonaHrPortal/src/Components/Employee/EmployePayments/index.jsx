...
const initialTransactions = [
    ...
    { id: 'EMP003', item: 'Laptop', orderBy: 'John Doe', from: 'Amazon', date: '2024-03-10', paidBy: 'Visa', status: 'Approved', amount: '500' },  // Duplicate Entry
    { id: 'EMP004', item: 'Desktop', orderBy: 'Jane Smith', from: 'Flipkart', date: '2024-02-15', paidBy: 'PayPal', status: 'Rejected', amount: '1200' }, // Duplicate Entry
];
